        ...
        <div className='h-[100vh] pt-8 bg-login-bg bg-cover'>
            ...
            <div className='w-1/3 mx-auto bg-slate-200 bg-opacity-25 border border-slate-500 rounded-md p-8'>
                <form className='flex flex-col gap-2' onSubmit={handleSubmit(onSubmit)}>
                    <h2 className='text-3xl font-semibold text-center'>Login to Continue!</h2>
                    <hr />
                    ...
                    />
                    <Link to="/register" className='text-sm text-blue-600'>Don't have an account ? Please Register!</Link>
                    {/* --- login button --- */}
                    <input className='text-xl text-white bg-slate-700 hover:bg-white hover:text-slate-800 duration-300 w-1/2 mx-auto mt-2 pt-1 pb-2 border-2 border-slate-700 rounded-lg' type="submit" value="Login" />
                </form>
